...
<head>
    ...
    <!-- Title -->
    <title>Desa Sebelimbingan | {{ $title ?? '' }}</title>

    <!-- Favicon -->
    <link rel="icon" href="{{ asset('templates/frontend/clever') }}/img/core-img/kukarrrr.png">
    ...
    <header class="header-area">
        ...
        <div class="top-header-area d-flex justify-content-between align-items-center">
            ...
            <div class="contact-info">
                <a href="#"><span>Desa</span> SEBELIMBINGAN </a>
                <a href="#"><span>Kabupaten</span> KUTAI KARTANEGARA </a>
            </div>
            <!-- Follow Us -->
            <div class="follow-us">
                <span>Follow us</span>
