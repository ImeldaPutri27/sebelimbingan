...
// Contact (FIXED)
Route::get('/potensi', [ContactController::class, 'index'])->name('potensi'); // halaman form
Route::post('/potensi', [ContactController::class, 'store'])->name('potensi.store'); // aksi kirim form
